...
return array(
    ...
    "'%value%' contains characters which are non alphabetic and no digits" => "'%value%' contiene caracteres que no son alfabáticos ni dígitos",
    ...
    "'%value%' contains non alphabetic characters" => "'%value%' contiene caracteres no alfabáticos",
    "'%value%' is an empty string" => "'%value%' es una cadena de texto vacia",
    ...
    "Too much words, maximum '%max%' are allowed but '%count%' were counted" => "Demasiadas palabras, solo se permiten '%max%' pero se han contado '%count%'",
...
// Zend_Validate_GreaterThan
    ...
    "Invalid type given, the value should be a integer, a float or a numeric string" => "El tipo especificado es inválido, el valor deberá ser un entero, un float o una cadena de texto numérica",
