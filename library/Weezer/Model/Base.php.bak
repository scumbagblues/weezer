...
class Weezer_Model_Base extends Zend_Db_Table_Abstract{
	...
	/**
	 * 
	 * M�todo que obtiene la información de un registro
	 * por su ID
    ...
    /**
     * 
     * M�todo para obtener un array de registros
     * @param unknown_type $where
     * @param unknown_type $order
     */
    public function getAll($where=null, $order=null){
        //devuelve todos los registros de la tabla filtrado y ordenado seg�n los par�metros enviados
