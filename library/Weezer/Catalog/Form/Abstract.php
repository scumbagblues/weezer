...
abstract class Weezer_Catalog_Form_Abstract extends Zend_Form{
	...
	public static function getCatalogConfig($table_config,$config_file = 'catalogs.ini'){
		
		$config_table	= new stdClass();
		$catalog_config = new Zend_Config_Ini(APPLICATION_PATH . '/configs/' . $config_file, $table_config);
